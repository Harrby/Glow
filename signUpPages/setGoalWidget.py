...
class SetGoal(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.description = QtWidgets.QLabel(
            "Final Question... Would you like to set a goal for our journey together"
        )
        ...
        self.no_button.clicked.connect(self.on_button_click)
    ...
    def resizeEvent(self, event):
        ...
        self.no_button.setFont(font_button)
        ...
        self.no_button.setMinimumHeight(button_height)
        self.yes_button.setMinimumWidth(button_width)
        self.no_button.setMinimumWidth(button_width)
